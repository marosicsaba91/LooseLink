...
public class ServiceLocatorSceneGameObjectTests
{
    ...
    UnityServiceLocatorTestComponent3 _testComponent3;
    const string testConstant1 = "You have My sword!";
    const string testConstant2 = "And My Bow!";
    const string testConstant3 = "And My Axe!";
    ...
    public IEnumerator Test2_AddGameObjectSourcesToInstaller()
    {
        ...
        _testComponent3 = AddServiceGameObject<UnityServiceLocatorTestComponent3>("GameObject3", out _testSource3);
        _testComponent3.TestValue = testConstant3;
    ...
    public IEnumerator Test3_GetSourceFromLocator()
    {
        ...
        var service3 = ServiceLocator.Get<IUnityServiceLocatorTestInterface>();
        bool foundService3 = service3.TestValue == testConstant3;
