...
namespace Tests
{
    public class ServiceLocatorPrefabTests
    {
        ...
        { 
            ...
            ServiceLocator.TryGet(out IUnityServiceLocatorTestInterface service3);
            bool service3Found = service3 != null;
            Assert.IsTrue(service3Found);
            bool service3IsInstantiatedToScene = service3.GameObject.scene.IsValid();
            Assert.IsTrue(service3IsInstantiatedToScene);
            bool service3IsInstantiatedFromTestPrefab3 = service3.GameObject.name == _testPrefab3.name;
